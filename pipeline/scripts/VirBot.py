...
# Have removed the standard run in directory and added a arg parser for defining reference database location
...
def virbot_cmd():
    ...
    parser.add_argument('--refdatabase', default="database", type=str, help="directory of stored viral references")
    args = parser.parse_args()
    return args

args = virbot_cmd()

print(args.refdatabase)

VirBot_path = args.refdatabase
